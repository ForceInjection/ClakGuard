...
- [2] DataDog, "GuardDog," _GitHub_, 2024. [Online]. Available: https://github.com/DataDog/guarddog
- [3] OSCAR, "OSCAR: Detecting and Analyzing Malicious Packages," _arXiv_, 2024. [Online]. Available: https://arxiv.org/html/2409.09356v1
- [4] Socket Inc, "Socket.dev," _Socket_, 2024. [Online]. Available: https://socket.dev/
- [5] Semgrep Inc, "Semgrep," _Semgrep_, 2024. [Online]. Available: https://semgrep.dev/
- [6] The Falco Project, "Falco," _Falco_, 2024. [Online]. Available: https://falco.org/
- [7] CNCF, "Open Policy Agent," _OPA_, 2024. [Online]. Available: https://www.openpolicyagent.org/
...
恶意 Skill 不仅仅是传统的「恶意插件」问题，而是结合了多种攻击向量的复合风险：
...
| 3    | 静态代码分析 | `StaticCodeScanner`, `DependencyAuditor`         | AST、Semgrep、正则匹配 |
...
DependencyPoisonDetector 从多个维度审查 Skill 声明的依赖项，识别私有包仿冒、版本号异常和安装脚本钩子等供应链攻击手法。
...
**检测模式：** CPU 耗尽、内存耗尽、磁盘填充、Fork 炸弹等。
